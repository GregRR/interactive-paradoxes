...
- Read in full (magazine PDF) and independently cross-checked against the Australian Skeptics summary and a Skeptical Inquirer overview to verify this citation. Confirmed word-for-word: over 3,800 predictions by 207 self-described psychics, published in Australian media 2000-2020, classified as 11% correct, 53% wrong, 15% expected/obvious, 19% too vague, 2% unknown. A systematic observational audit, not peer-reviewed. Basis for the exhibit's default actual hit rate (11%) and for labeling the non-correct 89% "non-hits" rather than "misses," since over a third of that 89% was too vague, too obvious, or unverifiable to count as a scored miss.
