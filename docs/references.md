...
- Core conceptual foundation of the exhibit: their Bayesian account defines a coincidence as "an event that provides support for an alternative to a current theory, but not necessarily enough support to accept that alternative in light of its low prior probability." Basis for the exhibit's central distinction between an interesting pattern, evidence for an alternative process, and having enough evidence to prefer that alternative; also basis for treating coincidence detection itself as reasonable rather than an error.
...
- Cited, per the source spec document, for a "3C" framework distinguishing coincidence detection, causal-mechanism search, and coincidence-versus-cause judgment — used narrowly here to support the idea that noticing a pattern can appropriately prompt investigation without by itself settling what caused it.
...
- The study separately measures coincidentality alongside event uncertainty, hypothesis belief, and surprise as predictors. Used narrowly to support keeping "how striking a cluster looks," "how unlikely it is under chance," and "how well the alternative model predicts the whole sequence" as three separate quantities rather than one.
...
- Cited, per the source spec, as the formal origin of the scan statistic used here: the maximum event count in a moving window of fixed width, compared against a null model. Basis for using a fixed 6-slot window as the exhibit's scan statistic rather than an ad hoc "does this look clustered" judgment.
...
- Cited, per the source spec, for temporal cluster detection using moving windows compared with an expected background rate. Background support for the "Show me the math" modal's local-cluster section.
...
- General methodological background on scan-statistic-based outbreak/trend detection, not evidence that this exhibit's toy model is a disease-surveillance method.

Kass, R. E., & Raftery, A. E. (1995). Bayes factors. *Journal of the American Statistical Association*, 90(430), 773–795. https://doi.org/10.1080/01621459.1995.10476572
- Standard reference for the Bayes factor as a measure of evidence between two hypotheses; used here as background for presenting the evidence ratio on a continuous scale rather than as a binary verdict.
...
- Discusses how multiple endpoints and near-miss matching inflate apparent coincidence rates, and states the "law of truly large numbers": with a large enough sample, any outrageous thing is likely to happen. Basis for the exhibit's caution that a single striking pattern must be evaluated against the actual opportunity space, not treated as self-evidently rare.
...
Note: the page's "Research behind this" section also flags an unsourced claim (that solid squares read as more "deliberate" than asymmetric clusters of the same size, motivating squares-only detection) as still awaiting a verified citation. This claim should not be treated as backed by research until a source is found and confirmed against this project's citation-verification standard.

## The Jeane Dixon Effect

Saunders, R. (2021). The Great Australian Psychic Prediction Project. *The Skeptic*, 41(4). https://www.skeptics.com.au/wp-content/uploads/magazine/The%20Skeptic%20Volume%2041%20%282021%29%20No%204%20%28Cover%29.pdf
- A systematic, non-peer-reviewed observational audit of over 3,800 predictions by 207 self-described psychics, published in Australian media 2000-2020, classified as 11% correct, 53% wrong, 15% expected/obvious, 19% too vague, 2% unknown. Basis for the exhibit's default actual hit rate (11%) and for labeling the non-correct 89% "non-hits" rather than "misses," since over a third of that 89% was too vague, too obvious, or unverifiable to count as a scored miss.

Madey, S. F., & Gilovich, T. (1993). Effect of temporal focus on the recall of expectancy-consistent and expectancy-inconsistent information. *Journal of Personality and Social Psychology*, 65(3), 458–468. https://doi.org/10.1037/0022-3514.65.3.458
- Across four experiments, when a prediction's outcome was temporally unfocused (no known date, matching how most psychic predictions are phrased), participants recalled confirming events far more often than disconfirming events — 60.8%/21.7%, 62.8%/28.2%, 81.9%/29.2%, and 48.4%/27.3% across the four experiments. This asymmetry narrowed substantially (but never fully closed) when the expected outcome's timing was made specific. Basis for the exhibit's default "hits remembered" (60%) and "non-hits remembered" (25%) slider values, taken as a deliberately rounded, center-of-range reading of the unfocused-condition numbers above; and for the "how memory recall works" framing distinguishing one-sided events (only a confirming outcome registers as a noticeable event) from two-sided events (both outcomes are equally noticeable).

Watt, C., Ashley, N., Gillett, J., Halewood, M., & Hanson, R. (2014). Psychological factors in precognitive dream experiences: The role of paranormal belief, selective recall and propensity to find correspondences. *International Journal of Dream Research*, 7(1), 1–8. https://doi.org/10.11588/ijodr.2014.1.11218
- An independent replication of Madey & Gilovich's selective-recall paradigm in a precognitive-dream context found participants recalled a mean of 2.09 of 4 confirming dream-event pairs versus 0.86 of 4 disconfirming pairs, and found no significant relationship between the size of this recall bias and participants' paranormal belief (measured two ways). Reinforces that the selective-recall effect is not confined to one lab's original paradigm, and supports not tying the exhibit's framing to any particular belief in the predictions being tested.
...
- A meta-analysis of 54 experiments found memory was often better for expectancy-incongruent than expectancy-congruent information on recall and recognition-sensitivity measures, while recognition measures left uncorrected for response bias showed the opposite tendency (over-reporting congruent information as having been seen). Cited as a caution against treating "people always remember confirming evidence better" as a universal law; the Jeane Dixon Effect as modeled here is one well-documented case (unfocused, one-sided expectations) rather than a claim about memory bias in general.
...
- In two experiments, recognition memory for information supporting a participant's own position on gun control was higher than for opposing information. Cited as convergent evidence for asymmetric memory recall in a different (attitude-based, rather than one-sided-event) paradigm; not used to set any slider default.
...
- Across four controversial topics (N=199), confirmation bias was found in information search and, for some topics, in interpretation, but not in memory recall — no difference in recall of confirming versus disconfirming information for any topic. Cited as an explicit, important null result: selective-recall effects on memory are not universal across every paradigm, which is why this exhibit frames the phenomenon it models (asymmetric recall of one-sided, temporally unfocused predictions) narrowly rather than as a general "confirmation bias in memory" law.

Berthet, V., Teovanović, P., & de Gardelle, V. (2024). A common factor underlying individual differences in confirmation bias. *Scientific Reports*, 14, 27795. https://doi.org/10.1038/s41598-024-78053-7
- Across three unrelated hypothesis-testing paradigms (N=200), participants rated confirming outcomes as "previously seen" more often than disconfirming outcomes for logical-rule (60.0% vs. 43.2%) and numerical-rule (65.3% vs. 42.2%) hypotheses, but showed no such asymmetry for personality-trait hypotheses (49.4% vs. 49.9%, not significant). This measure is explicitly regardless of accuracy — a raw yes/no familiarity judgment that conflates genuine recognition with response bias — so it is not used to set any slider default. Cited only as background showing that even a confirmation-flavored memory bias does not appear reliably in every hypothesis-testing context, echoing Vedejová & Čavojová's null result above.

Caballero, A., & López-Pérez, R. (2024). Memory bias beyond ego: Selective recall of positive financial outcomes. *Journal of Economic Psychology*, 105, 102771. https://doi.org/10.1016/j.joep.2024.102771
- In an incentivized experiment (N=448), outcomes that produced a financial payoff for the participant were recalled more often than non-paying outcomes, an average recall advantage of about 4.66 percentage points; despite this selective recall, participants showed no systematic overestimation of the true proportion of paying outcomes. Cited as evidence that valence-dependent selective recall generalizes beyond social/attitudinal contexts into a simple incentivized-memory paradigm, though the domain (financial payoff, not prediction confirmation) is different enough that it is not used to set any slider default.

[Jeane Dixon effect — Wikipedia](https://en.wikipedia.org/wiki/Jeane_Dixon_effect)
- Linked as the further-reading source at the bottom of the exhibit.

[The Great Australian Psychic Prediction Project — Australian Skeptics summary](https://www.skeptics.com.au/psychic-project-full-results-released/)
